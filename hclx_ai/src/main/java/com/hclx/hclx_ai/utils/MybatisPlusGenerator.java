package com.hclx.hclx_ai.utils;
...
public class MybatisPlusGenerator {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3333/aidb?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8", "root", "123")
